...
#
# Generated by Vivado on Tue Apr 18 09:54:44 +0200 2023
...
# Script info
echo -e "RAM_PROGRAM.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_PROGRAM xil_defaultlib.RAM_PROGRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RAM_PROGRAM -key {Behavioral:sim_1:Functional:RAM_PROGRAM} -tclbatch cmd.tcl -log simulate.log
}
