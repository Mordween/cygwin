...
HD_PWD='C:/cygwin/home/alexandre/plasma/vhdl/plasma_hw/plasma_hw.runs/VGA_PROM_DINO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_PROM_DINO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_PROM_DINO.tcl
